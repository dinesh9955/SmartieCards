...
//	7bb5939870e8b88d2eb20a660803e150

//	https://developer.spotify.com/console/get-several-albums/
//4aawyAB9vmqN3uQ7FjRGTy

	public static final String BASE = "http://smartiecards.com/";

//	public static final String BASE_ADMIN_MAIN = BASE+"admin/";

	public static final String BASE_MAIN_URL_ANDROID = BASE+"android/";
//	public static final String BASE_MAIN_URL_IOS = BASE+"ios/";

	public static final String BASE_MAIN__PROFILE_URL = BASE+"profile_photos/";
	public static final String BASE_MAIN__SUBJECT_IMAGE_URL = BASE+"images/";
	public static final String BASE_MAIN__CARD_IMAGE_URL = BASE+"images/";
	public static final String BASE_MAIN__ADDS_IMAGE_URL = BASE+"images/";


	public static final String REGISTER_DEVICE_ID = BASE_MAIN_URL_ANDROID+"device-token.php?";

	public static final String ABOUTUS = BASE_MAIN_URL_ANDROID+"aboutus.php?";
	public static final String TERMS = BASE_MAIN_URL_ANDROID+"termsconditions.php?";
	public static final String PRIVACY = BASE_MAIN_URL_ANDROID+"privacy.php?";

	public static final String CURRENCY = "$";
	public static final String TERM = "/Year";

	public static final String SHUFFLE = "Ownership of Site; Agreement to Terms of Use\n" +
	...
	public static final String MATCHES = "Indica qui le certificazioni, le attività di volontariato, i vari corsi di formazione non ancora indicati.";

    public static final String TIMED = "Senza sovrastimare il tuo livello, indica quali lingue padroneggi. Tieni presente che 100% indica una conoscenza da madrelingua.";
...
//			==================
//
//	Client ID:   AdnM_ntOetSx3rMGBTrhPhoaLC58AiPNSusInQDFSMNhMajMbGeC2St8Rexvv2ZNeNJqdEPlrK75BK6L
//	Secret:   EEEzfipa1rWC6mFsPM4tvM71-1EQqYJTe3Oqd-z3QcqgG_G9c7gasEX-YxBrX4Hg_G5ChEa7_aOzFGoj
//

	private static final String CONFIG_ENVIRONMENT = PayPalConfiguration.ENVIRONMENT_SANDBOX;
	private static final String CONFIG_CLIENT_ID = "ATsqS6S2X27R4d187bQ5fpVV02-W3LGAaSIoGe1t_gLXuJK2Ws3JHDiwsZ6SCrbac5_a_1FnYghy5kF9";

//	private static final String CONFIG_ENVIRONMENT = PayPalConfiguration.ENVIRONMENT_PRODUCTION;
//	private static final String CONFIG_CLIENT_ID = "AdnM_ntOetSx3rMGBTrhPhoaLC58AiPNSusInQDFSMNhMajMbGeC2St8Rexvv2ZNeNJqdEPlrK75BK6L";
	...
	.acceptCreditCards(true)
			.merchantName("Smartie Cards").languageOrLocale("en")
	...
	public boolean checkNetwork(Context firstScreen) {
		boolean connected = false;
		ConnectivityManager connectivityManager =
				(ConnectivityManager)firstScreen.getSystemService(Context.CONNECTIVITY_SERVICE);
